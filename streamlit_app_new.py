...
# Local model path (default). Place your .h5 here when committing to GitHub.
# Use absolute path to ensure the model is found regardless of working directory
DEFAULT_MODEL_PATH = os.path.join(os.path.dirname(__file__), "Zuzik_mri_model_final22.h5")
...
def _ensure_model_present(local_path: str = DEFAULT_MODEL_PATH):
    ...
    if not MODEL_URL:
        ...
        raise FileNotFoundError(
            f"Model not found at {local_path} and no MODEL_URL secret provided."
        )
